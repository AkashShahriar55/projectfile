...
public class DriversFragment extends Fragment {
    ...
    private List<DriverItem> driverItems = new ArrayList<>();
    ...
    private void initializeRecyclerView() {
        recyclerViewDrivers = getView().findViewById(R.id.DriversRecyclerView);

        mAdapter = new DriverItemAdapter(driverItems,getContext());
        ...
        recyclerViewDrivers.setAdapter(mAdapter);
    }
        ...
        FirebaseUtilClass.getDatabaseReference().child("Driver").child("Drivers").orderByChild("name").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                    driverItems.add(dsp.getValue(DriverItem.class)); //add result into array list
                }
