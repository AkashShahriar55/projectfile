...
public class LocationItemAdapter extends RecyclerView.Adapter<LocationItemAdapter.LocationViewHolder>
    ...
    private List<LicationItem> itemList;
    private List<LicationItem> itemListFiltered;
    ...
    public class LocationViewHolder extends RecyclerView.ViewHolder {
        ...
        public LicationItem getItem() {
            return item;
        }

        public void setItem(LicationItem item) {
            this.item = item;
        }
    }

    public LocationItemAdapter(List<LicationItem> itemList, Context context) {
    ...
    public void onBindViewHolder(@NonNull LocationItemAdapter.LocationViewHolder locationViewHolder, int i) {
        final LicationItem item = itemListFiltered.get(i);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<LicationItem> filteredList = new ArrayList<>();
                    for (LicationItem row : itemList) {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                itemListFiltered = (ArrayList<LicationItem>) results.values;
